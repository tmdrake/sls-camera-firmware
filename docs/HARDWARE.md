...
|------|-----|--------------|--------------------|-----|--------|
| **tablet-01** RCA W101AS23T2 | [devices/rca-w101as23t2.md](devices/rca-w101as23t2.md) | 800×1280 portrait | **1280×800** landscape | **2 GB** | Atom x5-Z8350; OTG **lab** stick/NIC; dedicated 5 V charge; **speakers = SST + force Speaker** ([recipe](devices/rca-w101as23t2.md#rca-speaker-fix-full-stack-lab-validated-2026-07)) |
