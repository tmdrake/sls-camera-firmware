...
| [20-phase1-kinect-live.png](20-phase1-kinect-live.png) | **2026-07-22** Phase 1 **live Kinect** (USB passthrough) — depth+SLS, IR PiP, status **Live** |
...
# host screenshots
virsh -c qemu:///system screenshot sls-appliance-phase1 /path/out.png
```

Isochronous USB can glitch under SPICE; bare metal remains field truth for audio/touch.
