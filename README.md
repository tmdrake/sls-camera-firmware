...
See [docs/FIRST-BOOT.md](docs/FIRST-BOOT.md) and [docs/images/](docs/images/README.md) (shortcut: `screenshots` → `docs/images`) — Lubuntu desktop + SLS `--demo` UI.
...
```text
sls-camera-firmware/
  docs/           Architecture, build, offline, first-boot, hardware, branding
